  ...
  return (
    <Container>
      <Left>
        <Logo>Fashion</Logo>
        <Desc>
          Thanks for your interest in Fashion. Please use this link if you have
          any questions about our products and we will get back with you very
          soon. Our support team makes sure that you get the best advice and
          guidance regarding whatever queries you have.
        </Desc>
        <SocialContainer>
